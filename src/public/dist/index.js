...
})({"4yBIY":[function(require,module,exports) {
...
var _updateSetting = require("./update-setting");
...
if (userPhoto) userPhoto.addEventListener("change", userPhotoPreview);
if (mapbox) {
...
if (userDataForm) userDataForm.addEventListener("submit", (e)=>{
    ...
    (0, _updateSetting.updateInfo)(formData);
});
if (userSettingForm) userSettingForm.addEventListener("submit", async (e)=>{
    e.preventDefault();
    document.querySelector(".btn-update--password").textContent = "Updating...";
    const oldPassword = document.getElementById("password-current").value;
    const newPassword = document.getElementById("password").value;
    const newPasswordConfirm = document.getElementById("password-confirm").value;
    await (0, _updateSetting.updateInfo)({
        oldPassword,
        newPassword,
        newPasswordConfirm
    }, "password");
...
if (btnLogout) btnLogout.addEventListener("click", (0, _login.signout));
if (btnBookTour) btnBookTour.addEventListener("click", (e)=>{
    e.target.textContent = "Processing ...";
    const { tourId } = e.target.dataset;
    (0, _stripeDefault.default)(tourId);
});

},{"./login":"lukEF","./mapbox":"ctncG","./update-setting":"baxWL","./stripe":"aMxX9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lukEF":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
const signout = async ()=>{
    try {
        ...
        if (res.data.status === "success") {
            setTimeout(function() {
                if (window.location.href.split("/")[3] === "account") window.location.assign("http://localhost:8080/overview");
                else window.location.reload();
            }, 2000);
            (0, _alert.showAlert)("success", "Loggout success");
        }
    } catch (error) {
        (0, _alert.showAlert)("error", "Loggout Failed");
    }
};

},{"axios":"jo6P5","./alert":"dpOzM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"ctncG":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "displayMap", ()=>displayMap);
const displayMap = (locations)=>{
    mapboxgl.accessToken = "pk.eyJ1IjoidHJpbmd1eWVuMTk0IiwiYSI6ImNtMWFyOWdoeDFpcnAybHF4eTE3OHhjb3oifQ.2YMMOgYpXIRL7zGyhlqi1A";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"baxWL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _alert = require("./alert");
const updateInfo = async (payload, type)=>{
    try {
        const url = type === "password" ? "http://localhost:8080/api/v1/auth/update-password" : "http://localhost:8080/api/v1/users/me";
        const res = await (0, _axiosDefault.default)({
            method: "PATCH",
            url,
            data: payload
        ...
        if (res.data.status === "success") {
            (0, _alert.showAlert)("success", `${type === "password" ? "PASSWORD" : "INFORMATION"}  Updated`);
            setTimeout(()=>{
...
},{"axios":"jo6P5","./alert":"dpOzM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aMxX9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _alert = require("./alert");
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
const stripe = Stripe("pk_test_51Q599dB25ODPKXFCKkuIagl9vpWWxVgteX5TQfL3VjQ2IamGARbpMrLnGtwVoIdoKmcX1Pa1ZT82vg94yjb43AJb00m4sDNrnJ");
exports.default = bookTour = async (tourId)=>{
    try {
        const response = await (0, _axiosDefault.default).get(`http://localhost:8080/api/v1/booking/checkout-session/${tourId}`);
        const sessionId = response.data.session.id;
        // Redirect to Stripe Checkout
        const result = await stripe.redirectToCheckout({
            sessionId
        });
        if (result.error) // Display error message to the customer
...
},{"./alert":"dpOzM","axios":"jo6P5","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["4yBIY","dq5Q2"], "dq5Q2", "parcelRequire11c7")
